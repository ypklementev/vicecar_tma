...
// import {useGetRepairs} from "@/api/api.ts";
...
// }
//
// export const EditServiceModal = ({debounceRef, useMutation} : EditServiceModalProps) => {
//   const { car, setIsModalOpen, menuId } = useAppContext()
